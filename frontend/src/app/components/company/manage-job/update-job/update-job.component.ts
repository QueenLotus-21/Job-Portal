...
export class UpdateJobComponent implements OnInit {
  ...
  err:any
   ...
   return this.form.controls;
    ...
    update1(title:string,JobRole:string,gender:string,salary:string,status:string,skill:string,workhour:string,person:string,description:string,responsibility:string,CompanyName:string,location:string,contact_info:string){
